...
def perform_eda(df):
    ...
    # generating customer age histogram
    plt.figure(figsize=(20, 10))
    df['Customer_Age'].hist()
    plt.savefig('./images/customer_age_hist.png')

    # generating marital status histogram
    plt.figure(figsize=(20, 10))
    df.Marital_Status.value_counts('normalize').plot(kind='bar')
    plt.savefig('./images/marital_status_hist.png')

    # generating total trans ct plot
    plt.figure(figsize=(20, 10))
...
def classification_report_image(y_train,
    ...
    plt.text(
        0.01, 0.7, str(
            ...
            'fontsize': 10}, fontproperties='monospace')
    plt.axis('off')
    plt.savefig('./images/RFTrain_RFTest.png')
    ...
    plt.text(
        0.01, 0.7, str(
            ...
            'fontsize': 10}, fontproperties='monospace')
    plt.axis('off')
    plt.savefig('./images/LRTrain_LRRgression.png')
...
def train_models(X_train, X_test, y_train, y_test):
    ...
    plt.show()
    plt.savefig('./images/rfc_disp.png')
    ...
    lrc_plot.plot(ax=ax, alpha=0.8)
    plt.show()
    plt.savefig('./images/lrc_plot.png')
